      ...
      <div className="about-section flex flex-row items-center gap-11 max-md:flex-col">
        ...
        <div className="about-main flex-2 min-w-[260px]">
          ...
          <div className="about-actions flex gap-4 items-center mt-2">
            ...
            <a href="https://www.linkedin.com/in/shashank-raj-577bb8255/" className="icon-box w-12 h-12 rounded-full bg-[#f6f8fc] shadow-md border border-[#e3e6fa] flex items-center justify-center text-xl text-[#5a48fa] hover:bg-[#eaeaff] hover:border-[#b6baff] hover:text-[#2d1e94] transition" target="_blank" rel="noopener" title="LinkedIn">
            ...
            <a href="https://drive.google.com/file/d/129BeCPIhm_A-_tAdAcl5JEAKFrzvOAA1/view?usp=sharing" className="resume-btn bg-[#e3e6ff] text-[#5a48fa] rounded-full font-bold px-6 h-12 flex items-center gap-2 border border-[#e3e6fa] shadow-sm hover:bg-[#d0d8ff] hover:text-[#2d1e94] hover:border-[#b6baff] transition" target="_blank" rel="noopener" title="Resume">
